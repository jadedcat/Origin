...
public class Core {
	...
	public void config(FMLPreInitializationEvent event) {
		...
		String csCate = "Crafting and Smelting", general = Configuration.CATEGORY_GENERAL;
	...
	public void vanillaCraftSmelt() {
		...
		if (Core.lead) GameRegistry.addRecipe(new ItemStack(Items.lead, 1),
		...
		if (Core.sapling) GameRegistry.addRecipe(new ItemStack(Blocks.sapling, 1, 0),
				"xxx", " c ", "vvv", 'x', Items.stick, 'v', Blocks.dirt, 'c', Blocks.log
		);
		if (Core.carrot) GameRegistry.addShapelessRecipe(new ItemStack(Items.carrot),
				Items.wheat_seeds, Blocks.leaves, new ItemStack(Items.dye, 1, 14)
		);
		if (Core.potato) GameRegistry.addShapelessRecipe(new ItemStack(Items.potato),
