...
import com.countrygamer.cgo.library.common.command.TeleportCommand
import com.countrygamer.cgo.library.common.extended.ExtendedSync
import com.countrygamer.cgo.library.common.helpers.{OptionHandler, RegisterHelper}
import com.countrygamer.cgo.library.common.network._
...
object Origin extends PluginWrapper {
	...
	final val clientProxy = "com.countrygamer.cgo.library.client.ClientProxy"
